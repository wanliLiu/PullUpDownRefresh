...
public class LoadMoreRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (LoadMoreRecyclerAdapter.this.onItemClickListener != null) {
                LoadMoreRecyclerAdapter.this.onItemClickListener.onItemClick(LoadMoreRecyclerAdapter.this, vh, position);
            }
    ...
    private class MyOnLongClickListener implements OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            int position = getRealPosition(vh.getLayoutPosition());
            if (LoadMoreRecyclerAdapter.this.onItemLongClickListener != null) {
                LoadMoreRecyclerAdapter.this.onItemLongClickListener.onItemLongClick(LoadMoreRecyclerAdapter.this, vh,
                        position);
            }
